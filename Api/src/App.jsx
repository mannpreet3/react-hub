...
function App() {
  ...
  const {isFecthing, error, setFetchData: setUserPlaces, fetchData:userPlaces } = useFetch(fetchUserPlaces, []);
    ...
    <>
      ...
      <main>
        ...
        {!error && <Places
          ...
          loadingText={'User places are fetching...'}
